    ...
    <>
      <BrowserRouter future={{ v7_startTransition: true, v7_relativeSplatPath: true }}>
        ...
        <Routes>
          ...
          <Route path='/category' element={<ProtectedRoute><AdminControl><AuthContext><Nav /><CategoryManage /> <Footer /></AuthContext></AdminControl></ProtectedRoute>} />
          <Route path='/lowstock' element={<ProtectedRoute><AuthContext><Nav /><LowStock /> <Footer /></AuthContext></ProtectedRoute>} />
          <Route path='/expense' element={<ProtectedRoute><AdminControl><AuthContext><Nav /><Expense /> <Footer /></AuthContext></AdminControl></ProtectedRoute>} />
